...
class RecallProposal(BaseModel):
    ...
    reasoning: str = Field(..., description="Why the system suggests recalling this")
    question: str = Field(..., description="The text to display to the user")
...
class LogenesisResponse(BaseModel):
    ...
    recall_proposal: Optional[RecallProposal] = None
    light_intent: Optional[LightIntent] = None
    visual_analysis: Optional[VisualParameters] = None
